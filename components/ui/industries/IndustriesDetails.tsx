...
export interface IndustriesDetailsTypes {
  industriesDetails: {
    id: string;
    industry_id: string
    slug: string;
...
const IndustriesDetails: React.FC<IndustriesDetailsTypes> = ({ industriesDetails, next_api_endpoint }) => {
  ...
  return (
    <>
      <section className={`container pt-20`}>
        {industriesDetails.map((items, index) => (
