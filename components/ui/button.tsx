  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors duration-300 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-neutral-950 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 dark:focus-visible:ring-neutral-300",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-[#FFFFFF] bg-transparent text-[#fff] text-base tracking-wide font-normal",
        primary: "bg-primary-100 text-[#fff] hover:bg-primary-200 text-base tracking-wide font-normal",
        secondary: "bg-midNight text-[#fff] text-base tracking-wide font-normal"
      },
      size: {
        default: "h-11 px-7 py-4 min-w-[118px] rounded-lg",
        sm: "h-8 rounded-md px-3 text-xs",
        lg: "h-[53px] rounded-lg px-9",
        icon: "h-9 w-9",
      },
    },
    defaultVariants: {
