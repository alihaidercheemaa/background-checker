        ...
        <section className="bg-[#000610] w-full">
            <div className="container py-20">
                <div className="flex flex-col mb-8">
                    <div className="mb-3">
                        <h1 className={`text-[#fff] sm:text-[46px] text-[42px] sm:leading-[55px] leading-[48px] font-bold font-[family-name:var(--font-Outfit)]`}>Efficient Working Process</h1>
                    </div>
                ...
                <div className='grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-8'>
                    <div className='bg-[#191F27] py-8 px-6 rounded-2xl'>
                        ...
                        <h1 className='text-[#fff] text-xl font-bold font-[family-name:var(--font-Outfit)] mb-3'>Coordination & Execution</h1>
                    ...
                    <div className='bg-[#191F27] py-8 px-6 rounded-2xl'>
                        ...
                        <h1 className='text-[#fff] text-xl font-bold font-[family-name:var(--font-Outfit)] mb-3'>Planning and Strategy</h1>
                        <div className='max-w-[515px] mx-auto'>
                    ...
                    <div className='bg-[#191F27] py-8 px-6 rounded-2xl'>
                        ...
                        <h1 className='text-[#fff] text-xl font-bold font-[family-name:var(--font-Outfit)] mb-3'>Secure Transportation</h1>
                        <div className='max-w-[515px] mx-auto'>
                    ...
                    <div className='bg-[#191F27] py-8 px-6 rounded-2xl'>
                        ...
                        <h1 className='text-[#fff] text-xl font-bold font-[family-name:var(--font-Outfit)] mb-3'>Real-Time Monitoring</h1>
                        <div className='max-w-[515px] mx-auto'>
                    ...
                    <div className='bg-[#191F27] py-8 px-6 rounded-2xl'>
                        ...
                        <h1 className='text-[#fff] text-xl font-bold font-[family-name:var(--font-Outfit)] mb-3'>Global Network</h1>
                        <div className='max-w-[515px] mx-auto'>
                    ...
                    <div className='bg-[#191F27] py-8 px-6 rounded-2xl'>
                        ...
                        <h1 className='text-[#fff] text-xl font-bold font-[family-name:var(--font-Outfit)] mb-3'>24-Hour Support</h1>
                        <div className='max-w-[515px] mx-auto'>
