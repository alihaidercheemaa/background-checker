            ...
            <div className='container'>
                <div className='sm:mb-12 mb-8'>
                    <div className='text-center mb-2'>
                        <h1 className={`text-[#1A1A1A] text-[43px] leading-[53px] font-bold font-[family-name:var(--font-Outfit)]`}>Our Services</h1>
                    </div>
                ...
                <div className='grid md:grid-cols-2 grid-cols-1 gap-8 max-w-[1100px] mx-auto'>
                    <div className='bg-[#ECEDF1] py-9 px-8 rounded-2xl'>
                        ...
                        <h1 className='text-[#1A1A1A] text-xl font-bold font-[family-name:var(--font-Outfit)] text-center mb-3'>Contract Logistics</h1>
                    ...
                    <div className='bg-[#ECEDF1] py-9 px-8 rounded-2xl'>
                        ...
                        <h1 className='text-[#1A1A1A] text-xl font-bold font-[family-name:var(--font-Outfit)] text-center mb-3'>Ocean and Air Freight</h1>
                        <div className='max-w-[515px] mx-auto'>
                    ...
                    <div className='bg-[#ECEDF1] py-9 px-8 rounded-2xl'>
                        ...
                        <h1 className='text-[#1A1A1A] text-xl font-bold font-[family-name:var(--font-Outfit)] text-center mb-3'>Warehousing and Storage</h1>
                        <div className='max-w-[515px] mx-auto'>
                    ...
                    <div className='bg-[#ECEDF1] py-9 px-6 rounded-2xl'>
                        ...
                        <h1 className='text-[#1A1A1A] text-xl font-bold font-[family-name:var(--font-Outfit)] text-center mb-3'>Consulting Services</h1>
                        <div className='max-w-[515px] mx-auto'>
