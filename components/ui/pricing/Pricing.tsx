...
const Pricing = () => {
    return (
        <>
            <section className="container w-full h-full py-20 relative">
                <div className="sm:mb-12 mb-8">
                    <div className="text-center">
                        <h1 className="text-midNight sm:text-[46px] text-[38px] sm:leading-[55px] leading-[42px] font-bold">Our Pricing Plans</h1>
                    </div>
                </div>

                <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-8 lg:space-y-0 lg:items-center">
                    <div className="group relative flex flex-col w-full bg-[#ECEDF1] lg:rounded-2xl md:rounded-xl rounded-lg transition-all duration-300 py-9 px-8">
                        <div className="border-b border-solid border-gray-200 pb-9 mb-9">
                            <div className="w-16 h-16 rounded-full bg-indigo-50 mx-auto flex justify-center items-center transition-all duration-300 group-hover:bg-indigo-600">
                                <svg className="w-6 h-6 text-indigo-600 transition-all duration-300 group-hover:text-white" viewBox="0 0 31 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <h3 className=" text-2xl font-bold my-7 text-center text-indigo-600">Free Plan</h3>
                        ...
                        <a href="javascript:;" className="py-2.5 px-5 bg-indigo-50 shadow-sm rounded-full transition-all duration-500 text-base text-indigo-600 font-semibold text-center w-fit mx-auto group-hover:bg-indigo-600 group-hover:text-white ">Purchase Plan</a>
                    ...
                    <div className="group relative flex flex-col w-full bg-[#ECEDF1] lg:rounded-2xl md:rounded-xl rounded-lg transition-all duration-300 py-9 px-8">
                        <div className="border-b border-solid border-gray-200 pb-9 mb-9">
                            <div className="w-16 h-16 rounded-full bg-indigo-50 mx-auto flex justify-center items-center transition-all duration-300 group-hover:bg-indigo-600">
                                ...
                                <svg className="w-6 h-6 text-indigo-600 transition-all duration-300 group-hover:text-white" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <h3 className=" text-2xl font-bold my-7 text-center text-indigo-600">Business Plan</h3>
                            <div className="flex items-center justify-center">
                                <span className=" text-4xl font-medium text-gray-900">$150</span>
                                <span className="text-xl text-gray-500 ml-3">|&nbsp; Month</span>
                            </div>
                        </div>
                    ...
                    <div className="group relative flex flex-col w-full bg-[#ECEDF1] lg:rounded-2xl md:rounded-xl rounded-lg transition-all duration-300 py-9 px-8">
                        <div className="border-b border-solid border-gray-200 pb-9 mb-9">
                            ...
                            <h3 className=" text-2xl font-bold my-7 text-center text-indigo-600">Enterprise Plan</h3>
                            <div className="flex items-center justify-center">
                                <span className=" text-4xl font-medium text-gray-900">$180</span>
                                <span className="text-xl text-gray-500 ml-3">|&nbsp; Month</span>
                            </div>
                        </div>
